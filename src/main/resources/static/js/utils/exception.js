...
function matchId(id) {
    ...
    } else if (id == "100_010_001") {
        alert("해당 날짜의 요청이 관리자의 처리를 기다리고 있습니다. 관리자에게 문의해주세요.")
    } else if (id == "400_010_002") {
        alert("해당 날짜에 근무일정이 없습니다. 관리자에게 문의해주세요.")
    } else if (id == "400_004_006") {
        alert("해당 날짜에 출퇴근기록이 존재할 경우 근무 일정 삭제가 불가합니다.")
    } else {
        alert("알 수 없는 오류입니다");
    }
}